...
while {true} do 
{
	...
	switch (_droidType) do
	{
		...
		case "ARC_LAAT_MK2": {moneyRequired = 50000, partsRequired = 0, droidDescription = "Once used by ARC troopers, it's now used by the superior ones!"};
		case "ARC_LAAT": {moneyRequired = 60000, partsRequired = 0, droidDescription = "Once use by ARC troopers, it's now used by the superior ones!"};
		// case "": {};
	...
	vehicleArray = ["CW_Ifrit_Mando_HMG", "CW_Ifrit_Mando", "k_CIS_Droideka", "ls_heli_laatle_transportGunship", "3as_arc_170_razor", "ARC_LAAT", "ARC_LAAT_MK2", "ls_ground_aat_black", "3AS_FieldCannon", "3as_ParticleCannon"];
