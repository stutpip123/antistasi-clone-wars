...
private _count = objNull;
{
	...
	_mags = getText (configFile >> "cfgMagazines" >> _magConfig >> "displayName");
	...
	if (!"CW_DroidParts" in _mags) then {} else {
...

{
	call {
		...
		private _mags = getText (configFile >> "cfgMagazines" >> _item >> "displayName");
