...
A3A_Reb_template = switch(true) do {
    ...
    case (A3A_hasCW): {
        ["Templates\NewTemplates\CW\CW_Reb_MANDO.sqf", independent] call A3A_fnc_compatibilityLoadFaction;
        Info("Mandalorian Template");
        "CW"
    };
    case (A3A_hasVN): {
...
A3A_Occ_template = switch(true) do {
    ...
    */
    ...
    case (A3A_hasCW): {
        ["Templates\NewTemplates\CW\CW_AI_REPUBLIC.sqf", west] call A3A_fnc_compatibilityLoadFaction;
        Info("Using Republic Template");
        "CW"
    };
    case (A3A_hasVN): {
