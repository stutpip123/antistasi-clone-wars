...
class droidProduction
{
	...
	class controls
	{
		...
		class startProduction: RscButton
		{
			idc = 1600;
			action = "execVM 'functions\factory\makeDroid.sqf'";
		...
		class droidDescription: RscText
		{
			idc = 1999;
			activeColor[] = {1,1,0,0};
		...
		class droidTextRequired: RscText
		{
			idc = 1003;
			activeColor[] = {1,1,0,0};

			text = "Droid Parts Required:"; //--- ToDo: Localize;
			x = 0.402031 * safezoneW + safezoneX;
			y = 0.225 * safezoneH + safezoneY;
			w = 0.216563 * safezoneW;
			h = 0.099 * safezoneH;
		};
		class droidDescriptionText: RscText
		{
			idc = 1002;
			activeColor[] = {1,1,0,0};

			text = "Description Of Droid:"; //--- ToDo: Localize;
			x = 0.402031 * safezoneW + safezoneX;
			y = 0.346 * safezoneH + safezoneY;
			w = 0.216563 * safezoneW;
			h = 0.099 * safezoneH;
		};
		class droidCancel: RscButton
		{
			idc = 1601;
			text = "Leave Droid Factory"; //--- ToDo: Localize;
			x = 0.592812 * safezoneW + safezoneX;
			y = 0.632 * safezoneH + safezoneY;
			w = 0.108281 * safezoneW;
			h = 0.055 * safezoneH;
			tooltip = "This will not cancel any current factory builds!"; //--- ToDo: Localize;
